...
flowchart TD
    ...
    style OFG fill:#fadbd8,stroke:#a93226,color:#1a1a2e
    style SPG fill:#fdebd0,stroke:#af7500,color:#1a1a2e
    style IDG fill:#d6eaf8,stroke:#1a5276,color:#1a1a2e
    style PCG fill:#d5f5e3,stroke:#1e8449,color:#1a1a2e
```
